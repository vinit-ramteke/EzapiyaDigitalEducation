...
public class unblockuser extends Fragment {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.unblockuserlayout, container, false);
        ...
        Globle_data.loginData.setUserID("12");
        String uid= Globle_data.loginData.getUserID();
        ...
        call.enqueue(new Callback<List<user>>() {
            ...
            public void onResponse(Call<List<user>> call, Response<List<user>> response) {
                ...
                userAdapter adapter = new userAdapter(array,"Unblock User",getContext(),getActivity());
